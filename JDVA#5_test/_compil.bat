...
sdcc -mz80 -c --std-c99 --opt-code-speed --oldralloc jdvapi_useless.c
...
sdcc -mz80 --code-loc 0x0138 --data-loc 0 --oldralloc --no-std-crt0 crt0_cpc.rel putchar_cpc.rel jdvapi_basic.rel jdvapi_frame.rel poisson.rel main.c
sdcc -mz80 --code-loc 0x0138 --data-loc 0 --oldralloc --no-std-crt0 crt0_cpc.rel putchar_cpc.rel jdvapi_basic.rel jdvapi_frame.rel jdvapi_useless.rel azrael.rel gargamel.rel hello.c
hex2bin main.ihx
hex2bin hello.ihx
