...
sdcc -mz80 --code-loc 0x0138 --data-loc 0 --oldralloc --no-std-crt0 crt0_cpc.rel putchar_cpc.rel jdvapi_basic.rel jdvapi_keyb.rel jdvapi_sync.rel puzz_mem.c
hex2bin main.ihx
hex2bin puzz_mem.ihx
CPCDiskXP -File main.bin -AddAmsdosHeader 100 -AddToNewDsk jdva6.dsk
CPCDiskXP -File puzz_mem.bin -AddAmsdosHeader 100 -AddToExistingDsk jdva6.dsk
pause