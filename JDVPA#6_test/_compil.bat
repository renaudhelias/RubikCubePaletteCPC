...
sdcc -mz80 --code-loc 0x0138 --data-loc 0 --no-std-crt0 crt0_cpc.rel putchar_cpc.rel jdvapi_basic1.rel jdvapi_keyb.rel jdvapi_frame.rel jdvapi_sync.rel jdvapi_floppy.rel moustache.c
hex2bin main.ihx
hex2bin moustache.ihx
CPCDiskXP -File main.bin -AddAmsdosHeader 100 -AddToNewDsk jdvpa6.dsk
