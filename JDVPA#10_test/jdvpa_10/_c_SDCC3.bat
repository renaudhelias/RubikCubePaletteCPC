...
sdcc -mz80 --code-loc 0x0138 --data-loc 0 --no-std-crt0 lib.rel crt0_cpc.rel putchar_cpc.rel pacman_sprites.rel ghost_sprites.rel blank_sprites.rel player.rel ghost.rel tiles.rel laby_data.rel sprite_collision.rel main.c
echo HEX2BIN ...
hex2bin main.ihx
echo CPCDISK ...
